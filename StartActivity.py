...
class StartActivity(Activity):
    ...
    def on_create(self):
        ...
        choose_library_activity_ref: Content = Content("Choose Library", self.widget)
        ...
        def local_lambda():
            ...
            self.escape()
            help_activity.show()
        help_activity_ref: Content = Content("Help", self.widget)
        help_activity_ref.set_action(local_lambda)

        score_board_activity_ref: Content = Content("Your score", self.widget)
